...
#NUM = [7,8,9,10]
#FILE_NAME_1 = 'com_pos_forward_0118.csv'
FILE_NAME_1 = 'com_pos_vel_ang.csv'
""" FILE_NAME_2 = 'com_pos_slope_5.csv'
FILE_NAME_3 = 'com_pos_slope_3.csv'
FILE_NAME_4 = 'com_pos_slope_5.csv'
NUM = [5,6,5,6]
 """
""" FILE_NAME_1 = 'com_pos_initial_height.csv'
FILE_NAME_2 = 'com_pos_initial_vel.csv'
FILE_NAME_3 = 'com_pos_initial_vel_10.csv' """
#NUM = [11,12,13]
# CSVファイルを読み込む
rospack = RosPack()
...
plt.plot(x_steps, np.array(data_1[1][0:0+steps]))
