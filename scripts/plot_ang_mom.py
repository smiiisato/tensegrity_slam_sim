...
FILE_NAME_2 = 'com_vel_friction_1_second.csv'
FILE_NAME_3 = 'com_vel_terrain_0.csv'
FILE_NAME_4 = 'com_vel_friction_10.csv' """
FILE_NAME_1 = 'ang_mom_vel_ang.csv'
FILE_NAME_2 = 'ang_mom_forward_0118.csv'
#FILE_NAME_2 = 'com_vel_slope_5.csv'
"""FILE_NAME_3 = 'com_vel_slope_3.csv'
FILE_NAME_4 = 'com_vel_slope_5.csv' """
""" FILE_NAME_1 = 'com_vel_initial_height.csv'
FILE_NAME_2 = 'com_vel_initial_vel.csv'
FILE_NAME_3 = 'com_vel_initial_vel_10.csv' """
#NUM = [1,2,3,4]
#NUM = [7,8,9,10]
#NUM = [5,6,5,6]
#NUM = [11,12,13]
...
plt.plot(x_steps, np.array(data_1[2][OFFSET:OFFSET+steps]), label="ang_mom_vel_ang")

plt.plot(x_steps, np.array(data_2[2][OFFSET:OFFSET+steps]), label="ang_mom_forward_0118")
...
print(np.var(data_1[2][0:steps]))
print(np.var(data_2[2][0:steps]))
""" print(np.mean(data_2[1][500:500+steps]))
print(np.mean(data_3[1][0:steps])) """
