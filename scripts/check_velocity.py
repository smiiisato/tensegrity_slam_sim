...
def update1(frame):
    xdata1.append(frame)
    ydata1.append(average_velocity[0])
...
def update2(frame):
    xdata2.append(frame)
    ydata2.append(average_velocity[1])
...
def update3(frame):
    xdata3.append(frame)
    ydata3.append(average_velocity[2])
...
while viewer.is_running():
    ...
    for i in range(6):
        ...
        body_vel = qvel[i][0:3]
        angular_momentum += body_mass*np.cross(body_com_xpos-com_xpos, body_vel-com_qvel)
